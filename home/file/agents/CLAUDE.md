...
| `/commit-and-push-g` | Commit and Push | `~/.claude/skills/commit-and-push-g/SKILL.md` |
| `/compare-approaches-g` | Compare Approaches | `~/.claude/skills/compare-approaches-g/SKILL.md` |
...
| Skill | Title | Path |
|-------|-------|------|
| agent-compatibility-g | Agent Compatibility | `~/.claude/skills/agent-compatibility-g/SKILL.md` |
| agent-leverage-g | Agent Leverage | `~/.claude/skills/agent-leverage-g/SKILL.md` |
...
| microservice-patterns-g | Microservice Patterns | `~/.claude/skills/microservice-patterns-g/SKILL.md` |
...
| emoji-vocabulary-g | Emoji Vocabulary | `~/.claude/skills/emoji-vocabulary-g/SKILL.md` |
