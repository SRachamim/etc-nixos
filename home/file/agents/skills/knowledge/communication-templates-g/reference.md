...
Realistic good and bad examples for each tier in the **communication-templates-g** skill. Each example includes the principle mapping -- why the good version works and which principle the bad version violates.
...
- Violates **Delimit**: narrates the journey instead of the destination (per **objective-communication-g** > Summarising Changes).
...
- Violates **writing-style-g**: "Great question!" is a banned helpful-assistant pattern.
