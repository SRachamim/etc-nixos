...
Structural templates for every recurring external communication type. Each template is a fill-in-the-blank skeleton grounded in specific **objective-communication** principles.

This skill provides the **structure** layer. It does not duplicate:

- **objective-communication** -- the epistemological principles (what to say, how to organise)
- **writing-style** -- the voice execution (how to say it, LLM-tell avoidance)
- **external-communications** -- the operational rules (approval, formatting, Slack API)
- **commit-conventions** -- the commit hygiene rules (ordering, independence, focus)
- **code-review** -- the review standards (severity definitions, actionability, thread status)
...
**Register**: **writing-style** > PR/MR titles
...
**Register**: **writing-style** > PR/MR titles and descriptions
...
- Narrating intermediate approaches or abandoned paths -- violates Delimit (report net effect only, per **objective-communication** > Summarising Changes)
...
**Register**: **writing-style** > Commit messages
**Defers to**: **commit-conventions** for hygiene, ordering, and workspace-specific format
...
**Register**: **writing-style** > Slack and casual messages
...
**Register**: **writing-style** > Code review comments
**Defers to**: **code-review** for severity definitions, actionability, and thread status rules
...
- Praise comments ("Nice refactor here") -- violates Delimit (not actionable; the **code-review** skill forbids them)
...
**Register**: **writing-style** > PR/MR comments
...
**Register**: **writing-style** > Work-item descriptions

Other item types (Epic, User Story) follow their own workflows -- see the **prd-intake** skill.
