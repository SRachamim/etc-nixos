...
- **architect-thinking-g** -- options thinking, rate of change, decision quality
- **design-lenses-g** -- refactoring, flexibility, and architecture evaluation
- **functional-typescript-g** -- type-driven development, coding standards
- **refactoring-g** -- behaviour-preserving transformations
- **test-driven-development-g** -- red/green/refactor cycle
