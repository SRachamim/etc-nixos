...
3. **Select tools**: enable MCP servers the automation needs (fundguard, Azure DevOps, Slack). Enable "Comment on PR" or "Send to Slack" built-in tools as appropriate.
