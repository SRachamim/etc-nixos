...
> **Scope**: Target architecture patterns -- what good FP TypeScript looks like (domain modeling, workflows, DI, event sourcing, codecs, testing, flexibility design). For *transformation mechanics* (how to refactor from bad to good), see the **refactoring-g** skill's [reference.md](../refactoring/reference.md).
