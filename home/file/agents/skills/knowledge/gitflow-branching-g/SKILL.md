...
- The **worktree-layout-g** skill dictates worktree paths and branch creation commands -- follow it for physical layout even when its starting-point branch differs from Gitflow's default.
- The **commit-conventions-g** skill governs commit structure -- follow it regardless of Gitflow's implied practices.
- Skills like **checkout-worktree-g** and **close-worktree-g** encode specific branch lifecycle steps -- follow those skills as written.
