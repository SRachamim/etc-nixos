...
| **Commit message** | Delimit, Structure, Self-containment | Defer to **commit-conventions-g** for format. Subject delimits; body structures the reasoning; avoid raising questions the diff cannot answer. |
