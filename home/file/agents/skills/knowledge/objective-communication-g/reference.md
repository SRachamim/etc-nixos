...
Detailed principles, extended examples, and checklists for the **objective-communication-g** skill. The agent reads this on demand when composing delivered text that warrants deeper guidance.
