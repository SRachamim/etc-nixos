...
Once all items are done, follow the hygiene section of the **commit-conventions-g** skill. The working tree must be clean before considering the plan complete.
