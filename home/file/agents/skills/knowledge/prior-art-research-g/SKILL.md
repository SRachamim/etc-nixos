---
name: prior-art-research-g
description: Researches established patterns and approaches from the functional programming, DDD, and Nix ecosystem literature before committing to a design. Use whenever the agent plans a feature, designs an architecture, or evaluates alternative approaches -- before drafting the solution.
---
...
| **Does it preserve options?**               | The pattern keeps future decisions open rather than locking in irreversible choices (per **architect-thinking-g** -- Options Thinking).                   |
...
- **architect-thinking-g** -- Options Thinking and Fit for Purpose guide pattern evaluation.
- **decision-priorities-g** -- the priority ladder (correctness, changeability, DX) breaks ties between candidate patterns.
- **design-lenses-g** -- the Flexibility lens principles (additive programming, combinators, Postel's law) help assess whether a pattern integrates well.
- **functional-typescript-g** -- the target idioms and standards that any adopted pattern must align with.