...
> **Scope**: Transformation mechanics -- step-by-step before/after refactorings. For *target architecture patterns* (domain modeling, workflows, DI, event sourcing, codecs, testing), see the **functional-typescript-g** skill's [reference.md](../functional-typescript/reference.md).
