...
> **Scope**: *How to develop test-first* in functional TypeScript. For what good FP TypeScript looks like, see the **functional-typescript-g** skill's [reference.md](../functional-typescript/reference.md). For how to refactor, see the **refactoring-g** skill's [reference.md](../refactoring/reference.md).
...
No mocking library needed. The algebra/interpreter split from the **functional-typescript-g** skill gives us the test boundary naturally.
