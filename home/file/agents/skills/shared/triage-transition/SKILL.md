...
This skill is internal plumbing -- called programmatically by skills that create or triage work items (e.g. **create-task**, **create-bug**, **triage**). When the user asks to triage a work item directly, use the **triage** skill instead.
...
2. Delegate to the **block-work-item** skill, passing the current work item as the blocked ID and the predecessor as the blocker ID.
