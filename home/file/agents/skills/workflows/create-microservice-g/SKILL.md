...
Require **Plan** mode following the **mode-gate-g** skill. Steps 2–12 are read-only analysis, design, and planning — Plan mode keeps the focus on correct boundaries and interfaces before any code is written. Step 13 switches to **Agent** mode for implementation.

Apply the **objective-communication-g** skill to all deliverable prose in steps 2–12.
...
- Once approved, implement following the **plan-execution-g** skill:
