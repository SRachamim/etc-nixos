---
name: investigate-incident-g
description: Gathers observability data from Datadog for a production incident and produces a structured investigation summary. Use when given an incident ID or a description of symptoms that need investigation.
...
Require **Debug** mode following the **mode-gate-g** skill. This command investigates a production incident -- Debug mode is the best fit.
...
Follow the **incident-response-g** skill for investigation structure and the **objective-communication-g** skill for all composed text.
