...
Follow the **incident-response** skill for investigation structure and the **objective-communication** skill for all composed text.
...
- Post the summary to a Slack channel (read and apply the **external-communications** skill before composing).
