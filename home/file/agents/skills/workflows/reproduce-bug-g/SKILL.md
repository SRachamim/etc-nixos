---
name: reproduce-bug-g
description: Gathers reproduction context and verifies a bug in the running local application via browser or API. Use when given a bug work item or a textual description of the defect.
...
- **If ticket**: apply the **work-item-context-g** skill to fetch the work item with full details, relations, comments, and hyperlinks. Additionally, extract file attachments from the relations array -- download screenshots and note video URLs for reference. From the fetched fields, extract:
...
Delegate to the **browser-bug-reproduction-g** skill, passing it:
