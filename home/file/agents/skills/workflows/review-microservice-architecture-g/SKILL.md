...
Require **Plan** mode following the **mode-gate-g** skill. Steps 1–13 are read-only analysis — Plan mode keeps the focus on assessment rather than premature fixes.
...
- Apply the **architect-thinking-g** skill, section: **Communication** (build ramps not cliffs, show the pirate ship, emphasis over completeness, five-second test).
