...
Require **Plan** mode following the **mode-gate-g** skill. The review is read-only analysis -- Plan mode keeps the focus on discussion rather than edits.
...
Apply the **prior-art-research-g** skill to check whether established patterns or approaches exist for the problem domain that the plan should have considered. Note any well-known patterns the plan aligns with or overlooks.
...
Apply the **commit-conventions-g** skill:
...
Apply the **objective-communication-g** skill to all review text.
