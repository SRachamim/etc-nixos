...
Require **Plan** mode following the **mode-gate-g** skill. The entire analysis (steps 1--6) is read-only.
...
For each recurring pattern, produce a proposal using the same categories as **continuous-improvement-g**:
...
- Target 60-80% context utilisation per the **context-engineering-g** skill.
