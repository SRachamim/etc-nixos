---
name: set-igw
description: Resolves the environment and organisation from an Azure DevOps work item, looks up the full environment name on Sunday, constructs the Internal Gateway URL, and sets INTERNAL_GATEWAY in the @fg/gql-api .env file. Use when given a ticket ID or URL to configure the internal gateway for local development.
