...
- Search agent artifacts for the governing criterion:
  - **Knowledge skills** in the skills root (e.g., **functional-typescript-g**, **commit-conventions-g**, **code-review-g**, **architect-thinking-g**, **design-lenses-g**).
...
For each approved gap candidate, follow the **create-task-g** skill with the drafted title and description. The **create-task-g** skill handles work item creation and triage.
