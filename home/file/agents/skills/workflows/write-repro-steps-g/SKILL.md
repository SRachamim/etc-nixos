...
Require **Plan** mode following the **mode-gate-g** skill. Steps 1--6 are read-only investigation and authoring. The user will switch to Agent mode for the apply step.
