...
- **No AI trailers** -- never include "Generated by Cursor", "Co-authored-by: cursor", or any other trailer or tag that reveals AI involvement. If the IDE appends one automatically, strip it before committing.
