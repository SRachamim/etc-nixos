---
name: set-port
description: Sets a custom port for @fg/gql-api and updates @fg/webapp to point to it, keeping both .env files in sync. Use when configuring the local development port so the webapp reaches gql-api at the correct address.
